            ...
            <div className='flex lg:flex-row flex-row-reverse justify-between h-auto lg:h-100 mt-6'>
                <div className='lg:mt-36 mt-4 lg:w-2/5 w-full h-full z-50'>
                    <div className='lg:absolute z-50 h-1/2 '>
                        <p className='lg:text-2xl xl:text-5xl text-3xl font-bold'>
                            Hey, ✌🏽 I am...️    
                        </p><br />
                        <p className='lg:text-[9.2rem] xl:text-[16rem] sm:text-[2rem] text-[4.2rem] ml-4 lg:-mt-16 font-extrabold'>
                            Rainsong
                        </p><br />
                        <p className='lg:text-2xl xl:text-5xl text-xl lg:font-normal font-bold lg:-mt-12 mt-2 mb-12'>
                            {'{{'} I mean, Rainsong NGOUTSOP.{'}}'}
                        </p>
                        <p className='lg:text-2xl xl:text-5xl text-xl lg:mt-4 mt-24 xl:leading-snug lg:leading-normal leading-relaxed w-full'>
